...
export const PRODUCTOS = [
...

  {
    ...
    pluginCategories: [
      {
        categoria: "Afinación, Pitch & Transformación Vocal",
        plugins: [
          { fabricante: "Antares", plugin: "Auto-Tune EFX AAX" },
          { fabricante: "Waves Audio", plugin: "Waves Tune Real-Time" },
          { fabricante: "SoundToys", plugin: "Little AlterBoy" },
        ],
      },
      {
        categoria: "EQ, Filtros & Limpieza Tonal",
        plugins: [
          { fabricante: "Avid", plugin: "EQ3 7-Band" },
          { fabricante: "FabFilter", plugin: "FabFilter Pro-Q 3" },
          { fabricante: "Plugin Alliance", plugin: "bx_digital V3" },
          { fabricante: "Waves Audio", plugin: "Scheps 73" },
          { fabricante: "Wavesfactory", plugin: "Trackspacer 2.5" },
          { fabricante: "SoundToys", plugin: "FilterFreak1" },
        ],
      },
      {
        categoria: "Dinámica, Compresión & Control",
        plugins: [
          { fabricante: "FabFilter", plugin: "FabFilter Pro-C 2" },
          { fabricante: "Waves Audio", plugin: "RCompressor" },
          { fabricante: "Waves Audio", plugin: "CLA-76" },
          { fabricante: "Waves Audio", plugin: "RVox" },
          { fabricante: "Waves Audio", plugin: "MV2" },
          { fabricante: "Plugin Alliance", plugin: "bx_opto" },
          { fabricante: "Plugin Alliance", plugin: "Purple Audio MC 77" },
          { fabricante: "Waves Audio", plugin: "OneKnob Pumper" },
        ],
      },
      {
        categoria: "Channel Strips & Procesamiento Integral",
        plugins: [
          { fabricante: "IK Multimedia", plugin: "TR5JoeChiccarelliVclStrp" },
          { fabricante: "Metric Halo", plugin: "MH ChannelStrip" },
          { fabricante: "iZotope", plugin: "Neutron 3 Elements" },
        ],
      },
      {
        categoria: "Reverbs & Espacios",
        plugins: [
          { fabricante: "Softube", plugin: "TSAR-1 Reverb" },
          { fabricante: "Avid", plugin: "D-Verb" },
          { fabricante: "Exponential Audio", plugin: "Stratus3D" },
          { fabricante: "Exponential Audio", plugin: "Symphony3D" },
          { fabricante: "FabFilter", plugin: "FabFilter Pro-R 2" },
          { fabricante: "Native Instruments", plugin: "Raum" },
          { fabricante: "SoundToys", plugin: "Little Plate" },
          { fabricante: "Valhalla DSP", plugin: "ValhallaRoom" },
          { fabricante: "Valhalla DSP", plugin: "ValhallaVintageVerb" },
          { fabricante: "Valhalla DSP", plugin: "ValhallaSupermassive" },
          { fabricante: "Waves Audio", plugin: "RVerb" },
          { fabricante: "Waves Audio", plugin: "TrueVerb" },
          { fabricante: "Waves Audio", plugin: "Abbey Road Chambers" },
          { fabricante: "Waves Audio", plugin: "IRLive" },
        ],
      },
      {
        categoria: "Delays & Echo",
        plugins: [
          { fabricante: "McDSP", plugin: "EC300" },
          { fabricante: "SoundToys", plugin: "PrimalTap" },
          { fabricante: "SoundToys", plugin: "EchoBoy" },
          { fabricante: "SoundToys", plugin: "EchoBoy Jr" },
          { fabricante: "Valhalla DSP", plugin: "ValhallaDelay" },
          { fabricante: "Waves Audio", plugin: "H-Delay" },
          { fabricante: "Waves Audio", plugin: "SuperTap 2-Taps" },
          { fabricante: "Waves Audio", plugin: "SuperTap 6-Taps" },
        ],
      },
      {
        categoria: "Chorus, Modulación, Doubling & Imagen Estéreo",
        plugins: [
          { fabricante: "Arturia", plugin: "Chorus JUN-6" },
          { fabricante: "AIR Music Technology", plugin: "AIR Chorus" },
          { fabricante: "AIR Music Technology", plugin: "AIR Ensemble" },
          { fabricante: "SoundToys", plugin: "MicroShift" },
          { fabricante: "TAL-Togu Audio Line", plugin: "TAL-Chorus-LX" },
          { fabricante: "Universal Audio / UADx", plugin: "UADx Studio D Chorus" },
          { fabricante: "Waves Audio", plugin: "Abbey Road Reel ADT" },
          { fabricante: "Waves Audio", plugin: "MetaFlanger" },
          { fabricante: "Waves Audio", plugin: "Doubler4" },
          { fabricante: "Waves Audio", plugin: "Doubler2" },
          { fabricante: "Valhalla DSP", plugin: "ValhallaSpaceModulator" },
          { fabricante: "SoundToys", plugin: "PanMan" },
          { fabricante: "Waves Audio", plugin: "Brauer Motion" },
        ],
      },
      {
        categoria: "Saturación, Lo-Fi & Color",
        plugins: [
          { fabricante: "AIR Music Technology", plugin: "AIR Lo-Fi" },
          { fabricante: "Avid", plugin: "Lo-Fi" },
          { fabricante: "Wavesfactory", plugin: "Cassette" },
          { fabricante: "XLN Audio", plugin: "RC-20 Retro Color" },
          { fabricante: "Waves Audio", plugin: "GTR Stomp 4" },
        ],
      },
      {
        categoria: "Experimental, Movimiento & Sound Design",
        plugins: [
          { fabricante: "Plugin Alliance", plugin: "Unfiltered Audio Fault" },
          { fabricante: "SoundToys", plugin: "Crystallizer" },
          { fabricante: "SoundToys", plugin: "EffectRack" },
          { fabricante: "Waves Audio", plugin: "CLA Effects" },
        ],
      },
      {
        categoria: "Utilidad & Gain Staging",
        plugins: [
          { fabricante: "Avid", plugin: "Trim" },
        ],
      },
    ],
    requisitos: "Ableton Live 11 o superior. Necesitas tener instalados los plugins listados.",
